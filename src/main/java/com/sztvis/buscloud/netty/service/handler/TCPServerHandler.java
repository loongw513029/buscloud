package com.sztvis.buscloud.netty.service.handler;

import com.sztvis.buscloud.netty.SessionManager;
import com.sztvis.buscloud.netty.service.TerminalMsgProcessService;
import com.sztvis.buscloud.netty.service.codec.MsgDecoder;
...
import com.sztvis.buscloud.util.TMPSConsts;
...
public class TCPServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private void processPackageData(PackageData packageData) {
        ...
        // 1. 终端心跳-消息体为空 ==> 平台通用应答
        if (TMPSConsts.msg_id_terminal_heart_beat == header.getMsgId()) {
        ...
        // 5. 终端鉴权 ==> 平台通用应答
        else if (TMPSConsts.msg_id_terminal_authentication == header.getMsgId()) {
        ...
        // 6. 终端注册 ==> 终端注册应答
        else if (TMPSConsts.msg_id_terminal_register == header.getMsgId()) {
        ...
        else if (TMPSConsts.msg_id_terminal_log_out == header.getMsgId()) {
        ...
        // 3. 位置信息汇报 ==> 平台通用应答
        else if (TMPSConsts.msg_id_terminal_location_info_upload == header.getMsgId()) {
