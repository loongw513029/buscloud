                        ...
                        <li>
                            <div class="work-inner">
                                <div class="work-item blue">
                                    ...
                                    <span class="num">540&nbsp;<span class="unit">台</span></span>
                                    <label>车辆总数</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="work-inner">
                                <div class="work-item purple">
                                    ...
                                    <span title="2000,00万" class="num">69&nbsp;<span class="unit">条</span></span>
                                    <label>线路条数</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="work-inner">
                                <div class="work-item gray">
                                    ...
                                    <span class="num">1000&nbsp;<span class="unit">次</span></span>
                                    <label>不良行为总数</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="work-inner">
                                <div class="work-item green">
                                    <i class="iconfont">&#xf00ca;</i>
                                    <span class="num">444&nbsp;<span class="unit">台</span></span>
                                    <label>在线台数</label>
                                </div>
                            </div>
                        </li>
